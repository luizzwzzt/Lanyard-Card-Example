...
function App() {
  const presence = useLanyardWs("852580927665209376");
  ...
  return (
    <div className="flex flex-col items-center w-full pt-16 pb-12">
      <header className="mb-12 text-center">
        <h1 className="text-4xl text-white font-bold font-['Poppins'] mb-2">Projeto Simples</h1>
        <p className="text-gray-500">Um exemplo usando API</p>
      </header>
      {presence ? (
            ...
            <img
              ...
              src={
                user!.avatar
                  ...
                  : `https://cdn.discordapp.com/embed/avatars/${parseInt(user!.discriminator.slice(-1), 10) % 5}.png`
              }
              alt="User Avatar"
            />
            <div>
              <h4 className="text-xl font-bold leading-6">
                {user!.username}
                <span className="font-normal text-gray-400 ml-1 text-lg">#{user!.discriminator}</span>
              </h4>
              <div className="flex flex-row items-center justify-center text-gray-400 sm:justify-start">
                <div className={`w-4 h-4 rounded-full ${StatusColor[presence.discord_status as keyof typeof StatusColor]} mr-2`} />
                <span>{status}</span>
              </div>
            </div>
          </div>
            ...
            <div className="mt-6">
              ...
              <div className="flex flex-row items-center rounded-lg overflow-hidden p-4 bg-[rgba(0,0,0,.2)]">
                <div className="w-20 h-20 min-w-[5rem] flex items-center justify-center relative mr-4">
                  <img className="rounded-xl" src={`${presence.spotify!.album_art_url}`} alt={`${presence.spotify!.song} art`} />
                  <img
            ...
            <div className="mt-4">
              ...
              <div className="flex flex-row items-center rounded-lg overflow-hidden p-4 bg-[rgba(0,0,0,.2)]">
                ...
                <div className="flex flex-col">
                  ...
                  {activity.details && <span className="text-sm text-gray-300">{activity.details}</span>}
                </div>
              </div>
            </div>
          )}
